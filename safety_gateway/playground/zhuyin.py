...
Conversion uses pypinyin (Style.BOPOMOFO), the most widely used Python Hanzi-to-reading
library. Display is W3C HTML Ruby built in the playground UI — not innerHTML of LLM text.
"""
