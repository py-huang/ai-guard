...
FEATURES: list[dict[str, str]] = [
    ...
    },
    {
        "id": "zhuyin_ruby",
        "status": "shipped",
        "title": "兒童回覆注音（Bopomofo on Web）",
        "detail": "畫面用 cmex-30/Bopomofo_on_Web 的 W3C <ruby> 與 BopomofoRuby 字體（輕聲在前、其餘調號在後）。漢字轉注音仍用 pypinyin，因為那個 repo 不做轉換。個資代號不標音。可在對話區開關。",
    },
    {
        "id": "parent_audit",
        "status": "shipped",
...
TUNABLES: list[dict[str, str]] = [
    ...
    {
        "name": "兒童注音",
        "where": "playground/static/bopomofo.css → BopomofoRuby；zhuyin.py 只負責讀音字串",
        "detail": "顯示跟 Bopomofo_on_Web 測試頁同一套字體與 ruby。讀音預設全標漢字，個資代號不標；多音字靠 pypinyin 詞組，要更準可換成教育部／萌典。",
    },
    {
        "name": "本機分享通行碼",
